...
public class UrlToSource {
	...
	/**
	 * Creates the DeptSourceCode object which has two fields url - holds the actual URL of the site
	 * that is being used outputFile - the file being used to store the taken source code, usually a
	 * .txt file.
	 * 
	 * @param inputUrl
