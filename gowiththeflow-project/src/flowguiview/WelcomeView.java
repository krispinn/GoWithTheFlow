...
public class WelcomeView extends JPanel {
	...
	/**
	 * Field for the string (HTML Tags) that will have all the steps needed to
	 * run the program.
	 */
	private String info = "<html><p>Welcome!<br><br>" + "Quick Tutorial:<br><br>"
			...
			+ "2) Select your College - ex: sciences<br><br>" + "3) Select your Major - ex: computerscience<br><br>"
	...
	/**
	 * Field for the string (HTML Tags) that explains the purpose of the
	 * application.
	 */
	...
	/**
	 * Constructor that sets up layout, creates two JLabels(for each string),
	 * then adds them to the view
	 */
	public WelcomeView() {
