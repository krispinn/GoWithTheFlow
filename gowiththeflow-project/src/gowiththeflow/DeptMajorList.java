...
/**
 * MatchPatternFromSourceCode finds a regular expression from source
 * code and outputs  what it finds to a text file.
 * 
...
public class DeptMajorList {
	...
	/**
	 * Constructor method MatchPatternFromSourceCode sets fields 'inputFile', 'expression', 
	 * and 'outputFile'
	 * 'outputFile' is a File object
	 * 
	 * A call is made to match() method.
	 * @param inputFileName Name of input file
	 * @param inputExpression Regular expression to match
	 * @param outputFileName Name of output file
	 * @throws Exception Throws Exception
	 */
	public DeptMajorList(	String inputFileName, 
	...
	/**
	 * match method creates four objects: 
	 * BufferedReader - used to read data from an input file.
	 * Pattern - used to match the pattern with the source code.
	 * FileWriter - used to create the file that the matches will be written to.
	 * BufferedWriter - used to efficiently write to output file
	 * 
